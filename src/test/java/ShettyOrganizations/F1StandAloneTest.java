...
public class F1StandAloneTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		F2LandingPage landingPage = new F2LandingPage(driver);
		driver.findElement(By.id("userEmail")).sendKeys("keshri21197@gmail.com");
